...
var ribbon = {
	...
	//======== SIZE ========
	boneWidth1200: 150,      //This is the width of each bone when the canvas size is 1200 pixels.
	boneWidth480: 30,        //This is the width of each bone with the canvas size is 480 pixels.
	ribbonWidth: 0,          //This computed [by getRibbonWidth()] value is a actual width of the ribbon segments.
	
	minLength: 400,          //This works similarly to the widths.
	maxLength: 800,
	minActualLength: 0,
	maxActualLength: 0,
	scalingLength: 1000,
	...
	ribbon.leftEdge = 0;     //These edges are recalculated by resizeCanvas().
	ribbon.rightEdge = 0;
	ribbon.topEdge = 0;
...
function resizeCanvas() {
	...
	ribbon.topEdge = ribbon.ribbonWidth / 3;
	if (ribbon.debugMode) {
