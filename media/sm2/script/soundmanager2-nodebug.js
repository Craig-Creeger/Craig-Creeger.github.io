...
function SoundManager(smURL, smID) {
  ...
  _createMovie = function(smID, smURL) {
    ...
    if (_isIE) {
      ...
      movieHTML = [
        '<object id="' + smID + '" data="../../soundmanagerv297a-20120513/script/' + smURL + '" type="' + oEmbed.type + '" title="' + oEmbed.title +'" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="../../soundmanagerv297a-20120513/script/' + _http+'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0">',
        param('movie', smURL),
